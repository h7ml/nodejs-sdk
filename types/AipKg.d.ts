...
declare class AipKg extends BaseClient {
     ...
     * @return {Promise} - 标准Promise对象
     */
    updateTask(id: integer, options: any): Promise<any>;
    /**
     * 获取任务详情接口
     *
     * @param {integer} id - 任务ID
     ...
     * @return {Promise} - 标准Promise对象
     */
    getTaskInfo(id: integer, options: any): Promise<any>;
    /**
     ...
     * @return {Promise} - 标准Promise对象
     */
    startTask(id: integer, options: any): Promise<any>;
    /**
     * 查询任务状态接口
     *
     * @param {integer} id - 任务ID
     ...
     * @return {Promise} - 标准Promise对象
     */
    getTaskStatus(id: integer, options: any): Promise<any>;
}
