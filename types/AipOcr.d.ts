...
declare class AipOcr extends BaseClient {
     ...
     * @return
     */
    meter(image: any, options: any): Promise<any>;
    /**
     * 网络图片文字识别（含位置版）
     * {string} image - 图像数据，base64编码，要求base64编码后大小不超过4M，最短边至少15px，最长边最大4096px,支持jpg/png/bmp格式
     * @param options - options列表
     ...
     * @return
     */
    webimageLoc(image: any, options: any): Promise<any>;
    /**
     * 出租车票识别
     * {string} image - 图像数据，base64编码，要求base64编码后大小不超过4M，最短边至少15px，最长边最大4096px,支持jpg/png/bmp格式
     * @param options - options列表
     * @return
     */
    taxiReceipt(image: any, options: any): Promise<any>;
    /**
     * 出租车票识别
     * {string} image - url
     * @param options - options列表
     * @return
     */
    taxiReceiptUrl(image: any, options: any): Promise<any>;
    /**
     * VIN码识别
     * {string} image - 图像数据，base64编码，要求base64编码后大小不超过4M，最短边至少15px，最长边最大4096px,支持jpg/png/bmp格式
     * @param options - options列表
     * @return
     */
    vinCode(image: any, options: any): Promise<any>;
    /**
     * VIN码识别
     * {string} image - url
     * @param options - options列表
     * @return
     */
    vinCodeUrl(image: any, options: any): Promise<any>;
    /**
     * 火车票识别
     * {string} image - 图像数据，base64编码，要求base64编码后大小不超过4M，最短边至少15px，最长边最大4096px,支持jpg/png/bmp格式
     * @param options - options列表
     * @return
     */
    trainTicket(image: any, options: any): Promise<any>;
    /**
     * 火车票识别
     * {string} image - url
     * @param options - options列表
     * @return
     */
    trainTicketUrl(image: any, options: any): Promise<any>;
    /**
     * 二维码识别
     *
